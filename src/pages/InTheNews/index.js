...
const InTheNews = () => {
  return (
    <section>
      ...
      <div className="my-16 max-w-[700px] text-2xl ml-[80px]">
      ...
      <div className="flex max-md:flex-col gap-14">
        <div className="">
          <div className="uppercase font-extra text-2xl">INTERVIEW | CGTN</div>
          <a
            href="https://youtu.be/5DJIgMJt_pw?si=P8eSllvspG0SIMdJ&t=173"
            className="text-3xl my-4 md:my-5 inline-block"
          >
            Biden Travels to UK to launch ‘Atlantic Declaration’
          </a>
        </div>
        <div className="">
          <div className="uppercase font-extra text-2xl">
      ...
      <Link to="/" className='btn2 max-w-[600px] mt-10'>See More</Link>
    </section>
  );
};
