  ...
  return (
    <div className="bg-[#1C1A1C]  text-white ">
      <div className="container mx-auto">
        <Header invert />
        <section className="mt-10 pb-10 border-white border-b-2 ">
        ...
        <section className="pb-[50px] md:pb-24 w-full flex max-md:block justify-between border-b-2 border-[#EDE9DF] gap-10 ">
        ...
        <section className="pb-[50px] md:pb-24 border-b-2 border-[#EDE9DF] ">
        ...
        <section className="pb-[50px] md:pb-24  flex gap-10  max-md:block  border-b-2  border-[#EDE9DF] ">
          <div className="w-full">
            <div className="w-full lg:max-w-[650px]">
              ...
              <div>
                <p className="border-b-2 lg:w-[50%] w-[80%] mb-4 pb-1 text-xl border-[#EDE9DF]">
        ...
        <section className="pb-[50px] md:pb-24 border-b-2 border-[#EDE9DF] flex max-md:block gap-10">
          <div className="w-full">
