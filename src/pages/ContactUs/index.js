            ...
            <form className="w-full md:w-2/3 lg:w-1/2">
              ...
              <div className="mb-5 group">
                ...
                <input
                  ...
                  name="fname"
                  id="fname"
                  className="block w-full text-xl border-b-2 border-white bg-transparent appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:border-blue-600 peer"
                  placeholder=""
                  required
                />
              </div>
              ...
              <div className="mb-5 group">
                ...
                <textarea
                  id="message"
                  rows="4"
                  className="block w-full p-2.5 text-xl border-white border-2 bg-black"
                />
              </div>
              <button
                type="submit"
                className="mt-8 w-80 h-12 border-2 border-white hover:bg-white hover:text-black text-xl"
              >
                Submit
              </button>
              <div className="mt-10">
              ...
              <div className="mt-10 mb-10">
                <h3 className="font-bold">UK Office Number</h3>
