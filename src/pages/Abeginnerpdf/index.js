    ...
    <div className="container mx-auto">
      ...
      <section className="mt-10 ">
        <h1 className="pb-10 max-md:pb-1">
          A beginner’s guide to geopolitical risk, and how its impacting fintech
        </h1>
        ...
        <div className="flex max-md:block">
          <div className="w-full pr-5">
            ...
            <div className="h-6" />
            <p className=" ">
              <span className="font-bold"> fintecy,</span> professionals
            ...
            <div className="h-6" />
            <p className=" ">
              <span className="font-bold">The first section,</span> “From Bone
              to Bitcoin” documents the evolution of fintech over its
              20,000-year history from primitive forms of accounting to the
              digital assets of today giving much-needed context to the
              importance and development of financial technology.
            </p>
            <div className="h-6" />
            <p className=" ">
              Section two,
        ...
        <div>
          ...
          <p className="  border-b border-b-slate-900">
            ...
            and at times unprecedented risk brought about by the convergence of
            the Global 4 which includes: Globalisation, Geopolitics,
            Transformative Technology, and Societal Change. We do this through
            our leading research house and strategic consulting. We tailor each
            engagement with bespoke insights and actionable intelligence so that
            clients feel confident they are making the right investing, business
          ...
          <p className="   border-b border-b-slate-900">
            FINTRAIL are a consultancy here to help you, your company, and your
            clients manage their exposure to the threat of financial crime and
            comply with any regulatory requirements. We're passionate about
            combating financial crime through the use of intelligent,
            commensurate, and inclusive programs working to disrupt criminal
            actors, whilst maintaining a best-in-class experience for your
            customers. We work with our clients to help them manage their risks
            through bespoke control frameworks, as well as providing subject
            matter expertise and training around financial crime laws and
            regulations and how to implement them in a way that works for you.
            <a
              className="underline decoration-2"
          ...
          <div className="pb-14  border-b border-b-slate-900">
            <div className="h-6" /> <div className="h-6" />
        ...
        <div className="flex   border-b border-b-slate-900 max-md:block">
          <div className=" w-full pr-5">
            ...
            <p className=" ">
              ...
              geopolitical risk describes the dynamics between nations. This
              distinction is evident in the insurance industry which
          ...
          <div className=" w-full">
            <div className="h-6 max-md:h-0" />
            <div className="bg-gradient-to-r from-[#8c52ff] to-[#5CE1E6] max-md:mt-[0px] mt-[90px] p-12">
        ...
        <div>
          ...
          <p>
            ...
            These include economic strength, active consumer market, production
            of systemically important resources, geostrategic positioning,
            technological leadership and military balance. Every nation, empire,
            kingdom and principality throughout history can be ranked against
            these six measures to determine their power and influence. Below are
            examples of how some countries rank in relation to these CoPs
          </p>
          <div className="h-6" />
          ...
          <div className="h-6" />
          <div>
            <p className="w-[300px] border-b-2 border-b-slate-900 mb-3"></p>

            <p>
              <sup className="mr-2">1</sup>MIGA WIPR REPORT, 2010. The Political
              Risk Insurance Industry. Chapter 3.{" "}
              <a
                className="underline decoration-2"
                href="https://www.miga.org/sites/default/files/archive/Documents/WIPR10ebookchap3.pdf"
                target="_blank"
              >
                WIPR10ebookchap3.pdf (miga.org)
              </a>
            </p>
            <div className="h-6" />
            <p>
              What is noteworthy to explore further is the United States visual.
            ...
            <div className="h-6" />
            <p>
              This example of extraterritoriality makes the US not only a
              geopolitically important nation but also by extension a global
              leader in the rules-based order. This title of the hegemon is
              being challenged as China develops its own CoPs to levels that
              also rival the United States.
            </p>
            <div className="h-6" />
            <p>
              ...
              regional/international affairs. The pie hasn’t changed because the
              US is taking a smaller slice, it’s changed because the pie has
              grown larger with more active players who have the financial
              capital to develop and pursue more ambitious regional and global
              agendas. The organic growth and reduction of nation’s CoPs over
              time is what we have called the “developmental differential” and
              this more accurately describes the rise and fall of globalised
              power.
            </p>
            <div className="h-6" />
            <p>
              ...
              customer. Furthermore, changing consumer trends and innovating
              consumer products are also important condensations that emerge
              from properly understanding the rise of globalised power which
              taken together are essential for both business growth and sound
            ...
            <div className="flex max-md:block">
              ...
              <div className="w-full pl-5">
                <div className="bg-gradient-to-r from-[#8c52ff] to-[#5CE1E6] max-md:mt-[50px] mt-[90px] p-12">
                  <span className="text-3xl font-bold text-white">
        ...
        <div className="h-6" />
        <div className="h-6" />
        <h3>Geopolitics & Fintech: A closer Examination</h3>
        <div className="h-6" />
        <p>
        ...
        <p>
          ...
          which as a secondorder effect means nations are tied closely to each
        ...
        <p>
          ...
          safety concerns. This also means fintechs need to be aware of these
          geopolitical changes especially because changing demographics impact
          compliance, operations as well as productmarket fit.
        </p>
        <div className="h-6" />
        <p>
        ...
        <div className="bg-[#F8F8F8]">
          ...
          <p>
            ...
            who are attracting this new wave of workers.
          </p>
          <div className="h-6" />
          <p>
            Whereas most fintechs in the UK as it pertains to BREXIT may be
            thinking of issues in relation to FCA led changes including
            passporting restrictions, licencing and others. It is the ability to
            horizon scan in non-linear ways like this that will allow a fintech
            to truly be ahead of the curve.
          </p>
        </div>
        <div className="h-6" />
        <p>
          ...
          compliance and operations. Some industries like oil and mining,
          however, have a much better grasp and appreciation of geopolitical and
          political risk as they have a history of operating in politically
          volatile emerging and frontier markets where they face issues in
          relation to sanctions, civil war, rebellion, strikes, riots, terrorism
          etc. Other industries however are less experienced, this has seen them
          in the crosshairs of geopolitical risk.
        </p>
        <div className="h-6" />
        <p>
          The following case study highlights how geopolitical risk has a
          business coupling effect between different industries, and again is
          another great example of non-obvious risk.
        </p>
        <div className="h-6" />
        <div className="h-6" />
        ...
        <div className="bg-[#F8F8F8]">
          <p>
            ...
            Zara, Diesel, H&M, and Chanel.
          </p>
          <div className="h-6" />
          <p>
            Reputation and brand management is a key variable for success in the
            fashion retail world. This is especially important when selling into
            foreign markets. The American fashion brand GAP was caught blind
            sighted by unexpected geopolitical risk in 2018 which is worth
            understanding.
          </p>
          <div className="h-6" />
          <p>
            ...
            mainland China and failed to include other territories like Taiwan,
            the South China Sea and South Tibet. This lack of geopolitical
            awareness led to a boycott of the brand by Chinese consumers and
            reputational damage to the brand and a drop in its stock price. In a
            statement GAP said it "sincerely apologised for this unintentional
            error". Furthermore, the company said it respects China’s
            “sovereignty”.
          </p>
          <div className="h-6" />
          <p>
            This should serve as a lesson to fintech for two main reasons as it
            pertains to business coupling
          </p>
          <div className="h-6" />
          <p>
          ...
          <p>
            ...
            business operations very difficult. This is why fintechs need to
            develop much better mechanisms in order to assess business risk and
            opportunity, especially as it pertains to business coupling in the
            face of geopolitical risk.
          </p>
        </div>
        <div className="h-6" />
        <div className="h-6" />
        ...
        <div className="">
          <div>
            <div className="flex gap-10 max-md:gap-0 max-md:flex-col">
              ...
              "
              >
                <img src="images/pdf/3.png" className="w-[100%] " />
                <img
                  src="images/pdf/Pareto.png"
