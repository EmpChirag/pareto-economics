        ...
        <div className="mt-10 max-w-[1180px]">
          ...
          <div className="">
            ...
            <p className="mt-[200px] max-md:mt-[100px] text-xl  before:absolute before:h-[1px] before:w-[230px] before:top-0 before:left-0 relative before:bg-black pt-5">
              <sup className="mr-2">3</sup> PwC Asset & Wealth Management,
              Luxembourg
            </p>
            <p>
            ...
            <p className="mt-[200px] max-md:mt-[100px] text-xl  before:absolute before:h-[1px] before:w-[230px] before:top-0 before:left-0 relative before:bg-black pt-5">
              <sup className="mr-2">5</sup> Bank of America Global Fund Manager
              Survey
            </p>
            <p className="pb-5">
            ...
            <p>
              <sup className="mr-2">8</sup> Bank of America Global Fund Manager
              Survey
            </p>
