        ...
        <div className=" max-w-[1180px]">
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              non-Chinese perspective. Little if any work covers this
            ...
            <p className=" pb-5">
              ...
              have developed and what problems the M&A community will most
              likely face in the near future. It ends with the reader having a
              more comprehensive understanding of the state of these
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              the sheer volume of work that has facilitated that position thus
              far. What is less available and also much less understood or
              misunderstood, is the Chinese perspective on the changing
              investment and geopolitical landscape, their opinions on the West
              and how they plan to engage with western and other global players
            ...
            <p className=" pb-5">
              ...
              overestimation of the West’s ability to absorb China into its way
              of doing things.
            </p>
            <div className="flex max-md:flex-col pb-5">
              <p className=" pb-5 w-full">
                ...
                1979 when the then Chinese Vice Premier Deng Xiaoping visited
                Texas under the leadership of the Carter administration. This
                was a memorable public display of Sino-US friendship which hoped
                to usher in a new age of normalisation based on a common belief
            ...
            <p className=" pb-5">
              ...
              both be with this new free market status quo, this was then hoped
              to lead to a transition of the political order from Communism to
              Democracy on the part of China, which would naturally lead to a
              changing of the political guard as democracy would dictate,
              therefore ensuring a dramatically reduced military threat from
            ...
            <p className=" pb-5">
              ...
              followed suit. This high export-led growth in South East Asia was
              to become known as the Asian Tigers. US businesses which produced
              low value goods like luggage for example were allowed to go out of
            ...
            <p className=" pb-5">
              ...
              have given up earlier attempts to transform the nation
              politically, focusing mainly on accommodating the political
              situation whilst simultaneously taking advantage of its
              manufacturing base. Consecutive US presidents have undermined the
              personality, and historical make-up of the Chinese, they have
              learnt the long and hard way that China is not as malleable and
              prone to outsider influence especially when it comes to how it
              runs its political affairs. Having spent 4,000 tumultuous years
              consolidating its landmass, the only way China continues to be as
              powerful as it is, is by having a centralised political system
              that it can control. Socialism with Chinese characteristics as
              former Vice Premier Deng Xiaoping put it shows China’s ability to
              be malleable and pragmatic…but on its own terms.
            </p>
            <div className="h-6" />
            <div className="bg-black text-white py-3">
              ...
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  An asymmetric understanding has developed between the West &
                  China which has resulted in missteps, underestimation of
                  China’s ambitions and overestimation of the West’s ability to
                  bring China into its flow.
                </li>
                <li className="my-2">
                  The policy of engagement with China began in 1972 with
                  President Nixon & Henry Kissinger and has spanned 8
                  presidential administrations who have all struggled with their
                  China policy due to partly a shallow understanding of China’s
                  ambition and a blindingly optimistic hope of reform as well as
                  the fact that China’s development strategy is holy unique to
                  its position, history and experience that cannot be compared
                  to America.
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              China is abandoning its long-term policy of ‘reform and opening
              up’, as China has reaffirmed their commitment to international
              trade, cooperation and economic governance. However, it does
            ...
            <p className=" pb-5">
              ...
              ensure the security of the industrial chain and supply chain, and
            ...
            <p className=" pb-5">
              ...
              2025" (中国制造2025) initiative, first unveiled in 2015, which
              outlines China’s plans for supply-side structural reform and a
              move away from low value-added manufacturing. China has vowed to
              develop a favourable policy environment for domestic firms in
            ...
            <p className=" pb-5">
              ...
              preferential treatment is likely to heighten accusations of
            ...
            <div className="bg-black text-white py-3">
              ...
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  In response to increasing external economic shocks, China’s
                  14th Five-Year Plan, formulated at the 19th Party Congress in
                  October, attaches great importance to the pursuit of
                  self-reliance and technological sovereignty.
                </li>
                <li className="my-2">
                  China is likely to strengthen industrial policies aimed at
                  financial, operational, and regulatory support for companies
                  in key sectors. This is strongly aligned with its "Made in
                  China 2025" (中国制造2025)
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              increase in trade and investment restrictions abroad. This
            ...
            <p className=" pb-5">
              ...
              acquisitions will be no exception. The acquisition of
              international brands and advanced technology can bring additional
              investment, consumption and employment opportunities to the
              country, and is likely to receive strong support from the Chinese
              Communist Party (CCP).
            </p>
            <div className="pb-5">
              <p className=" pb-2">
            ...
            <p className=" pb-5">
              ...
              it will steadily expand the QDLP pilot area, with plans to add
              Hainan Free Trade Port and Chongqing Municipality to carry out
              QDLP pilot projects to better support the construction of Hainan
            ...
            <p className=" pb-5">
              ...
              of increasingly suspicious and inhospitable environment for M&A.
            </p>
            <div className="h-6" />
            <div className="bg-black text-white py-3">
              <h3 className="mx-4 text-3xl">KEY TAKE AWAYS</h3>
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  In 2020, the volume of China’s M&A transactions has declined
                  for the fifth consecutive year, this is due to several factors
                  including heavier debt loads, tighter domestic liquidity
                  conditions, Beijing’s controls on outbound capital flow and an
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              constant theme has characterised the US-China relationship ever
              since and that is the consistent hands-on approach by the US to
            ...
            <p className=" pb-5">
              ...
              the Chinese before the Russians did in order to disrupt what could
            ...
            <div className="border-b-8 border-t-8 border-sky-600 mb-5">
              <p className="text-4xl font-bold my-3">
                <i>
                  ...
                  US to actively form and shape the relationship, or rather
                  shape what they wanted the Chinese to do in the relationship.
                </i>
              </p>
            </div>
            <p className=" pb-5">
            ...
            <p className=" pb-5">
              ...
              opening up its economy and allowing a transition to democratic
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              which includes the passing of the Foreign Investment Risk Review
            ...
            <p className=" pb-5">
              ...
              “mergers, acquisitions, or takeovers” by or with any foreign
              person that could result in foreign control of any United States
              business, including such a merger, acquisition, or takeover
              carried out through a joint venture that threaten to impair
              national security4. The seven largest investing countries are all
              United States allies. They include; the United Kingdom, Japan,
              Germany, France, Canada, Switzerland, and the Netherlands –
              combined they account for 72.1 percent of U.S. affiliate value
              added. In response, FIRRMA limits reviews on investments from
              companies in allied countries, or “excepted foreign states”
              including Australia, Canada and the UK in regards to
              non-controlling transactions. Furthermore, it gives these nations
            ...
            <p className=" pb-5">
              ...
              including information on: The Ultimate Beneficial Owner, Dollar
              amount invested, Type of investment: Greenfield/Brownfield,
              Sector, and an analysis of patterns in the investment and how they
              align with the Made in China 2025 strategy. Naturally the Chinese
              are unhappy about this and highlight the fact that the United
              States is restricting the opportunity for China to share in the
              same benefits afforded to the Asian Tigers by the US after the
              cold war, under the auspices of national security. In response,
              the Chinese National Development and Reform Commission (NDRC) and
              the Ministry of Commerce (MOFCOM) in December 2020 jointly
              released the new rules for reviewing foreign investment on
              security grounds. These are scheduled to come into force in
            ...
            <p className=" pb-5">
              ...
              national security. Given also the fact that there has been a
              creeping definition of what national security actually means, with
              industries like health and pharmaceuticals being watched even more
              closely. Given the spread of the coronavirus, national security no
              longer means warfare, but has developed a more sophisticated
            ...
            <p className=" pb-5">
              ...
              had an edge given the amount of state subsidy support they would
              receive, especially for State Owned Enterprises (SOE). With
              commodities experiencing a deflated price, this allows for rapid
            ...
            <p className=" pb-5">
              ...
              national security concern for the US, any attempt to take
              advantage of struggling US energy companies is curtailed with this
              act, giving a sizable opportunity for competitors to capitalise.
            </p>
            <div className="h-6" />
            <div className="bg-black text-white py-3">
              <h3 className="mx-4 text-3xl">KEY TAKE AWAYS</h3>
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  With the enactment of FIRRMA the US is more clearly defining
                  who its friends and foes are.
                </li>
                <li className="my-2">
                ...
                <li className="my-2">
                  The act underlines that ALL transactions made by entities of
                  China be tracked and monitored, including information on: The
                  Ultimate Beneficial Owner, Dollar amount invested, Type of
                  investment: Greenfield/Brownfield, Sector, and an analysis of
                  patterns in the investment and how they align with Made in
                  China 2025 strategy.
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <p className=" pb-5">
              ...
              public offering, and allows them to more easily become listed in
              U.S. markets5. Although reverse mergers are not inherently
              nefarious investing processes, but the way they have been used by
              Chinese companies has led to action from the US Security and
              Exchange Commission in the form of instituting a stricter set of
              listing rules and even delisting Chinese companies from US
              Exchanges. Since 2009 an estimated 300 Chinese firms have reverse
              merged or reverse IPO’d with American companies. Many Chinese
              firms which have performed a reverse merger in the US and Canada
            ...
            <p className=" pb-5">
              ...
              years ago via reverse merger. It was eventually delisted by the
              Ontario Securities Commission when evidence surfaced of endemic
              fraud by the company including overstating assets to the tune of
            ...
            <p className=" pb-5">
              ...
              2009, they began trading on the Nasdaq via a reverse merger when
              they took over the shell company TM Entertainment & Media. CME
              were found to be involved in several illegal practices including;
              management pump and dump schemes, false claims of business
              penetration claiming to advertise on 27,200 buses when in fact
              only 12,565 carried them, inflation of revenue figures by over
              $78m, claiming falsely to be associated with Apple. After several
              other negative news stories its auditors Deloitte Touche Tohmantsu
              (Deloitte affiliate) resigned. On the same day (11<sup>th</sup>{" "}
              March), CME shares were halted after a 48% decline caused by the
            ...
            <p className=" pb-5">
              ...
              Significant Risks from Chinese Companies was issued by President
              Trump, tasking the President’s Working Group on Financial Markets
              (PWG) with examining certain risk to investors in U.S. financial
              markets posed by the Chinese government’s failure to allow audit
              firms that are registered with the Public Company Accounting
              Oversight Board (PCAOB) to comply with U.S. securities laws and
              investor protection requirements7. The PWG recommended several
              measures that would protect investors including; enhancing listing
              standards to require, as a condition to initial and continued
            ...
            <p className=" pb-5">
              ...
              be satisfied by providing a co-audit from an audit firm with
              comparable resources and experience where the PCAOB determines if
            ...
            <div className="bg-black text-white py-3">
              ...
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  Reverse mergers are not inherently nefarious investing
                  processes, however, the way they have been used by Chinese
                  companies had led to action from the US SEC in the form
                  instituting a stricter set of listing rules and even delisting
                  Chinese companies from US Exchanges.
                </li>
                <li className="my-2">
                  Since 2009 an estimated 300 Chinese firms have reverse merged
                  or reverse IPO with American companies.
                </li>
                <li className="my-2">
                  The Trump administration took action on this via the
                  President’s Working Group on Financial Markets (PWG), which
                  recommended several measures that would protect investors
                  including; enhancing listing standards to require as a
                  condition to initial and continued exchange listing in the
                  United States, PCAOB access to work papers of the principal
                  audit firm for the audit of a listed company.
                </li>
              </ul>
            </div>
          </section>
          <section>
            ...
            <p className=" mb-5">
              ...
              using executive authority. However, recent signalling by the new
              Biden administration has showed he will be taking a more
              conciliatory tone with China, this move would please the Chinese
            ...
            <p className=" mb-5">
              ...
              keystone XL pipeline which struck a sour note with Canada, a
              reversal on travel bans targeting primarily Muslim countries and
              stopping construction of the border wall. However, his focus on
              other key policy issues such as; China, 5G security, illegal
              immigration, Iran, Nicaragua and Venezuela seem to have been
            ...
            <p>
              Former head of the Commodity Futures Trading Commission where he
              led derivatives markets reforms in the wake of the 2008 market
            ...
            <p className=" mb-5">
              ...
              with allies and resume multilateral cooperation. What is notable
              that bar a small handful of appointees, none have deep experience
              engaging with China which may present a problem especially as
            ...
            <p className=" mb-5">
              ...
              leadership it is unlikely that they will deviate much or not at
              all from their current dual circulation development model. This is
              because this model was developed in part due to the increasingly
              combative stance of the United States and formed with an
              underlining understanding that this would be the best road for
              China even if former President Trump won a second term. He didn’t,
            ...
            <p className=" mb-5">
              ...
              reverse mergers and compliant cross-border M&A activity.
            </p>
            <div className="h-6" />
            <div className="bg-black text-white py-3">
              <h3 className="mx-4 text-3xl">KEY TAKE AWAYS</h3>
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  Biden’s tough talk on China pre-inauguration has morphed into
                  a more conciliatory tone which has worried the US defence
                  establishment.
                </li>
                <li className="my-2">
                ...
                <li className="my-2">
                  The Chinese establishment have not commented on Biden’s
                  cabinet experience but rather have highlighted that his
                  selection marks “a return to the establishment” and expect
                  that diplomacy and national security policies will return to a
                  more traditional and professional style, without the
                  volatility of the prior Trump administration.
                </li>
              </ul>
            </div>
          </section>
          <section>
            ...
            <p className=" mb-5">
              ...
              visions, so when it comes to pan EU alignment on new, and at times
              contentious issues like Chinese FDI it becomes difficult to speak
              with one voice. The majority of Chinese FDI is in the form of
            ...
            <p className=" mb-5">
              ...
              however the rules and regulations are more blurred and less
              comprehensive when it comes to non-EU inbound M&A. This allows an
              unfair advantage for non-EU countries to use disproportionate
            ...
            <p className=" mb-5">
              ...
              adopting a White Paper on foreign subsidies in the Single Market
            ...
            <p className=" mb-5">
              ...
              and it seems to the EU that China isn’t. Furthermore, the EU has
              major concerns related to Chinese investment in Europe, including:
              an increase in China’s ability to wield political influence in
              Europe, problems related to Chinese corporate governance &
              business practice, a lack of investment reciprocity, and what
              would Chinese control of key/strategic industries like energy,
              natural resources, military production, and critical
              infrastructure e.g. 5G look like.
            </p>
            <div className="h-6" />
            <div className="bg-black text-white py-3">
              <h3 className="mx-4 text-3xl">KEY TAKE AWAYS</h3>
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  ...
                  strategy especially with China as all 27 member states have
                  their own perspectives, incentives and ambitions.
                </li>
                <li className="my-2">
                  Given the maturity and experience of EU companies in
                  industries like manufacturing, technology, logistics, robotics
                  and others, China is taking advantage of their ability to
                  provide state subsidies for M&A activity such as financing via
                  government supported investment funds e.g., Sino-CEEF Fund,
                  cheaper financing, loan guarantees, tax rebates etc.
                </li>
              </ul>
            </div>
          </section>
          <section>
            ...
            <p className=" mb-5">
              ...
              replace the Bilateral Investment Treaty (BIT) concluded between
            ...
            <p className=" mb-5">
              ...
              cooperation. It is hoped by the Chinese that the EU will adhere to
            ...
            <p className=" mb-5">
              ...
              knowledge that a Trump administration could not fire back at what
              is sees as a bad deal for the collective stance of democracy and
              human rights of the West. Furthermore, with the UK having
              “Brexited,” the EU needs to plug the gapping budgetary whole that
              the UK left which stands at £11 billion (US$15 billion) in 2018.
              Knowing the problems, the EU faces in terms of non-EU state
            ...
            <p className=" mb-5">
              ...
              World Health Organization, promote political settlement of
              international and regional hotspot issues, actively implement the
              G20 debt relief initiative, and support Africa’s anti-epidemic and
              development efforts. Promote world development and prosperity.
            </p>
            <div className="h-6" />
            <div className="bg-black text-white py-3">
              <h3 className="mx-4 text-3xl">KEY TAKE AWAYS</h3>
              <ul className="mx-4 list-disc pl-5">
                <li className="my-2">
                  Xi Jinping emphasised that China is committed to building a
                  new development pattern, which will provide Europe and the
                  world with more market opportunities and create greater space
                  for cooperation.
                </li>
                <li className="my-2">
                  Key Chinese Sectors opening to European Investment include;
                ...
                <li className="my-2">
                  The past Trump Administration were against any and all moves
                  by the EU to extend cooperation opportunities with perceived
                  US foes like Russia (Nord Stream) and especially China, Biden
                  is yet to comment on this agreement.
                </li>
              </ul>
            </div>
            <section>
              ...
              <p className=" mb-5">
                ...
                territory with a climate of economic uncertainty, an
                ever-consuming pandemic, shifting geopolitical sands and a
                leadership determined to prove that they are able to navigate
                the storms. Prime Minister Boris Johnson has a lot on his plate.
                He must now decide what role the UK plays in international
              ...
              <p className=" mb-5">
                ...
                times seem to be giving off mixed signals as it relates to
                China. The results of BREXIT have been similar for both sides
                for similar reasons. As we explored for the EU, they seek growth
                opportunities and new markets, the UK on the other hand is also
              ...
              <p className=" mb-5">
                ...
                Huawei. Pressure was building the for government to U-turn on
                their proposals to use Huawei technologies for Briton’s 5G
                infrastructure, its fate was sealed after Washington imposed
                sanctions claiming the firm poses a national security threat -
                something Huawei denies. Furthermore, the UK instructed UK
              ...
              <p className=" mb-5">
                ...
                with nations like China to be assessed on the basis that a
              ...
              <p className=" mb-5">
                ...
                cross-party support of this amendment including from former
                foreign secretary Jeremy Hunt and Conservative MP Ian Duncan
                Smith. On January Tuesday 19th this amendment was defeated by
                319 to 308.
              </p>
              <div className="h-6" />
              <div className="bg-black text-white py-3">
                ...
                <ul className="mx-4 list-disc pl-5">
                  <li className="my-2">
                    ...
                    independent voice following BREXIT, with Prime Minister
                    Johnson signalling to business his intentions which at times
                    seem to be giving off mixed signals regarding his China
                    policy.
                  </li>
                  <li className="my-2">
                    Johnson’s cabinet remains vehemently fractured regarding
                    their position on China, which has meant the UK has moved
                    very slowly with their China engagement policy, as was noted
                    with the U-turn on Huawei and voting down the “genocide
                    amendment” in a UK trade bill.
                  </li>
                </ul>
              </div>
            </section>
            <section>
              ...
              <p className=" pb-5">
                ...
                in the UK from which to operate a regional office. The UK leads
                in tech innovation, healthcare, R&D and media and continues to
                attract the attention of the M&A activity. However, as the UK
              ...
              <p className=" pb-5">
                ...
                the rest of the world. This balancing act comes in the form of
                the new National Security & Investment Bill (NSIB). Resembling
                the US Foreign Investment Risk Review Modernisation Act and
                other similar measures taken by other allies including Canada
                and Australia, the NSIB will give government new powers to
                screen investments on the ground of national security. Some
              ...
              <p className=" pb-5">
                ...
                China’s ability to do this. This is especially true when
                external expertise and innovation in areas with dual use
                capabilities are required to reach these aims.
              </p>
              <div className="h-6" />
              <div className="bg-black border border-black ">
                ...
                <ul className="list-disc px-5 text-white mx-5 pb-10 text-2xl">
                  <li className="pb-4">
                    The UK has moved to introduce new legislation which attempts
                    to protect national security whilst at the same time keeping
                    the UK open and attractive for business investment to the
                    rest of the world.
                  </li>
                  <li className="pb-4">
                    The NSIB will give government new powers to screen
                    investments on the ground of national security. Some
                    examples of “qualifying assets” which will aim to be
                    protected include: trade secrets, databases, source code,
                    algorithms, formulae, designs, plans, drawings and
            ...
            <section>
              ...
              <ol className="list-decimal mx-5 pb-10">
                <li className="pb-4">
                  How will a Biden administration tackle important national
                  security concerns whilst keeping the appetite for cross border
                  M&A high?
                </li>
                <li className="pb-4">
                ...
                <li className="pb-4">
                  How can the US, UK and EU present a united front when there
                  exists a fractured approach to Chinese investment?
                </li>
                <li className="pb-4">
                  What industries are the winners and losers when considering
                  the impact China’s dual circulation development strategy?
                </li>
                <li className="pb-4">
                ...
                <li className="pb-4">
                  How do foreign firms manage their growth strategy with China
                  as public pressure increases to cut ties with the nation due
                ...
                <li className="pb-4">
                  Can the Chinese Communist Party sustain power given its lack
                  of dollar reserves and growing M&A restrictions in key
                  markets?
                </li>
                <li className="pb-4">
                  How should M&A operators be hedging geopolitical risk and this
