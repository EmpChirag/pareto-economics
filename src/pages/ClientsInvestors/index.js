    ...
    return (
      <div className="container mx-auto">
        ...
        <HeroSection
          ...
          image={homeHer}
        />
        <section className="mt-10 border-b-2 py-10  border-black">
          <div>
            <div>
              {" "}
            ...
            <div className="flex ">
              ...
              <div className="w-full ">
                <div className="w-[280px]">
                  <p className="border-b-2   border-black w-[380px] text-2xl py-4">
                    Pareto helps with:
                  </p>
                  <p className="border-b-2   border-black w-[380px] text-2xl py-4">
          ...
          <div>
            <div className="flex max-xl:block">
              <div className="w-full ">
                ...
                <p className="border-b-2  border-t-2  border-black w-[380px] text-2xl py-4">
                  Hedge Funds
                </p>
                <p className="border-b-2   border-black w-[380px] text-2xl py-4">
              ...
              <div className="w-full max-xl:float-none float-right items-end flex">
                <div className="">
                  <p className="border-b-2   border-black w-[380px] text-2xl py-4 mt-10">
        ...
        <section className="mt-10 border-b-2   border-black pb-10">
