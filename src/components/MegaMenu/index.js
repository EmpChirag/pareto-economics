...
const MegaMenu = ({ menu, handleMenu, handleSearch }) => {
  return (
    <div
      className={`megaMenu absolute top-0 px-5 left-0 w-full bg-black md:h-screen text-white pb-10 duration-300 ${
        menu ? "opacity-100 pointer-events-all" : "opacity-0 pointer-events-none"
      }`}
    >
