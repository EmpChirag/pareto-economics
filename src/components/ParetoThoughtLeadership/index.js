...
const ParetoThoughtLeadership = () => {
  return (
    <section>
      <h2 className="text-3xl leading-[1.2] lg:text-6xl lg:leading-[1.3] lg:max-w-[780px]">
      ...
      <div className="flex justify-between max-md:flex-col mt-10 gap-5 md:gap-10">
        ...
        <div className="max-w-[600px] text-lg md:text-2xl">
      ...
      <div className="mt-8 flex max-md:flex-col gap-10 lg:px-10">
        <div className="">
          <div className="uppercase font-extra text-lg md:text-2xl">Insights</div>
          <a href="/" className="text-2xl md:text-3xl my-4 md:my-5 inline-block">
            How is M&A impacted by China’s ‘Dual Circulation’ Development
            Strategy?
          </a>
          <p className="font-extra text-lg md:text-2xl">
            “We focus on three key bilateral relationships, including; US-China,
            EU- China and UK-China”
          </p>
        </div>
        <div className="">
          <div className="uppercase font-extra text-lg md:text-2xl">PODCAST</div>
          <a href="/" className="text-2xl md:text-3xl my-4 md:my-5 inline-block">
